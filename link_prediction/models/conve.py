...
class ConvE(Model):
    ...
    def __init__(self,
        ...
        self.hidden_layer = torch.nn.Linear(self.hidden_layer_size, self.dimension).cuda() if torch.cuda.is_available() else torch.nn.Linear(self.hidden_layer_size, self.dimension).cuda()
