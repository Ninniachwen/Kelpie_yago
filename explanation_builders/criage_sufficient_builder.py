...
class CriageSufficientExplanationBuilder(SufficientExplanationBuilder):
    ...
    def __init__(self, model: Model,
        ...
        super().__init__(model, dataset, sample_to_explain, perspective, num_entities_to_convert, 1, output_prefix)
    ...
    def _compute_relevance_for_rule(self,
        ...
        filename1 = self.output_prefix + "_output_details_" + str(rule_length) + ".csv"
        print(filename1)
        with open(filename1, "a") as output_file:
